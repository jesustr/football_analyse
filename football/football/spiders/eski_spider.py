    ...
    # Paslara özel script 
        for tr in all_tr :          
            if len(tr.css('td::text').getall()) != 0 :
                if tr.css('td::text').getall()[1].strip() == 'Total Passes' : 
                
                    home_value = tr.css('span ::text').getall()[0] 
                    away_value = tr.css('span ::text').getall()[1] 
                    deneme['Total Passes_home'] = home_value
                ...
                elif tr.css('td::text').getall()[1].strip() == 'Passes':
                ...
                elif tr.css('td::text').getall()[1].strip() == 'Accurate Passes':
                ...
                elif tr.css('td::text').getall()[1].strip() == 'Accurate Passes Percentage':
